...
const SvgMarketplaceAndroid = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox='0 0 135 40' fill='#000' {...props}>
    ...
    <path
      ...
      fill='url(#marketplace-android_svg__a)'
    />
    <linearGradient
      id='marketplace-android_svg__b'
      gradientUnits='userSpaceOnUse'
      x1={33.834}
      y1={21.999}
      x2={9.637}
    ...
    <path
      ...
      fill='url(#marketplace-android_svg__b)'
    />
    <linearGradient
      id='marketplace-android_svg__c'
      gradientUnits='userSpaceOnUse'
      x1={24.827}
      y1={19.704}
      x2={2.069}
    ...
    <path
      ...
      fill='url(#marketplace-android_svg__c)'
    />
    <linearGradient
      id='marketplace-android_svg__d'
      gradientUnits='userSpaceOnUse'
      x1={7.297}
      y1={41.824}
      x2={17.46}
    ...
    <path
      ...
      fill='url(#marketplace-android_svg__d)'
    />
    <path
...
export default SvgMarketplaceAndroid;
